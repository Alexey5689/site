...
if (isset($_SESSION['ruser'])){
    ...
    echo '<input type="submit" value="Logout" id="ex" name="ex"class="btn btn-default btn-xs">
          </h4>';
    echo '</form>';
    //обработка выхода
    if (isset($_POST['ex'])) {
    ...
    else{//если пользователь не авторизован и не пытался ещё
        echo '<form action="index.php';
        //проверяем на какой странице были и возвращаем на неё
        if (isset($_GET['page'])){
           echo '?page='.$_GET['page']; 
        }
